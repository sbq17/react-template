...
export {}
declare global {
  const API_SYSTEM_MENU: typeof import('../src/api/system')['API_SYSTEM_MENU']
  const API_USER_LOGIN: typeof import('../src/api/auth')['API_USER_LOGIN']
  const Breadcrumb: typeof import('antd')['Breadcrumb']
  const BtnItem: typeof import('../src/components/BtnItem/index')['default']
  ...
  const SvgIcon: typeof import('../src/components/SvgIcon')['default']
  ...
  const formEditor2: (typeof import('../src/components/FormEditor/index'))['default']
  ...
  const useAxios: typeof import('../src/hook/useAxios')['useAxios']
  const useAxios2: (typeof import('../src/hook/useAxios'))['useAxios2']
...
declare global {
  // @ts-ignore
  export type { RouteProps, RouteObject } from 'react-router-dom'
  import('react-router-dom')
  // @ts-ignore
  export type { CustomRouteProp } from '../src/types/route.d'
  import('../src/types/route.d')
}
